// Next.js API route voor alle D2 formulieren
import { NextRequest, NextResponse } from 'next/server';

// Mock D2 form data (same as in the individual route)
const d2FormData = [
  {
  ...
  },
  {
    ...
    risksDiscussed: "Standaard risico's besproken",
    crow500: true,
    riskExplanation: "Duurzame technologieën vereisen extra aandacht",
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error fetching D2 forms:', error);
    return NextResponse.json({
      success: false,
      error: 'Failed to fetch D2 forms'
    }, { status: 500 });
  }
}
